...
export const AuroraBackground = ({ children, className }) => {
    return (
        <div className={cn("relative w-full min-h-screen overflow-hidden bg-void", className)}>
            ...
            <div className="absolute top-0 right-1/4 h-120 w-120 bg-paper rounded-full mix-blend-screen filter blur-[120px] opacity-10 animate-blob animation-delay-2000"></div>
            ...
            {/* Ruido sutil para textura sin depender de assets externos */}
            <div
