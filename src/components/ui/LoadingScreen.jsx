...
export default function LoadingScreen({ title = 'Cargando...', fullScreen = true }) {
        ...
        <div className={containerClasses}>
            ...
            <div className="relative flex flex-col items-center">
                ...
                <motion.p
                    ...
                    className="mt-6 text-sm font-bold uppercase tracking-[0.2em] text-cyan-400 drop-shadow-[0_0_8px_rgba(6,182,212,0.3)] font-['Orbitron']"
                >
                    {title}
                </motion.p>
            </div>
